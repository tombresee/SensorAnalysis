...
##  Motivation
- The Array of Things (AoT) Chicago sensor network is an extensive cluster with software-defined units performing multiple sensing duties, and we have used Folium (python geo-mapper) to plot all 126 sensor locations [here](https://rawcdn.githack.com/tombresee/SensorAnalysis/fa16bdfa1e93ac65a5494021f4ebc9339e8ec774/ENTER/code/node_locations_visualized/index.html)
